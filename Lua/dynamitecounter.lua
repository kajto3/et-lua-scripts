...
Version = 	"1.0"
Author  =   "Necromancer"
Description = "Dynamite Counter\n"
Modname = "Dynamitecounter"
...
MESSAGE[20] = "^1<TIME> ^wSeconds till ^3<PLACE> ^wexplosion!!"
MESSAGE[10] = "^1<TIME> ^wSeconds till ^3<PLACE> ^wexplosion!!"
MESSAGE[3] = "^1<TIME> ^wSeconds till ^3<PLACE> ^wexplosion!!"
MESSAGE[2] = "^1<TIME> ^wSeconds till ^3<PLACE> ^wexplosion!!"
MESSAGE[1] = "^1<TIME> ^wSecond till ^3<PLACE> ^wexplosion!!"
MESSAGE[0] = "^1>>> Boom <<<"
...
function et_InitGame(levelTime,randomSeed,restart)
	et.G_Print("[Dynamitecounter] Version:"..Version.." Loaded\n")
