...
if et.gentity_get(cno,"ps.ping") ~= 0 then
...
-- added rifle5v5 module of Perlo_0ung to let rifles spawn with 3 grenades

function et_ClientSpawn(clientNum,revived)
	if revived == 0 and et.gentity_get(clientNum, "sess.playerType") == 2 then
		et.gentity_set(clientNum,"ps.ammo",39,2)
		et.gentity_set(clientNum,"ps.ammo",40,2)
	end
end
