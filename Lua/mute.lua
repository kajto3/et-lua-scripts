...
function ClientUserCommand(PlayerID, Command, BangCommand, Cvar1, Cvar2, Cvarct)
	...
	elseif(string.lower(BangCommand) == "!admintest") then
		MyStatus(PlayerID)
		return 0
	elseif(string.lower(BangCommand) == "!help") then
...
function PutSpec(PlayerID)
	et.trap_SendConsoleCommand( et.EXEC_APPEND, "ref remove " .. PlayerID .. "\n" )
	et.trap_SendServerCommand( PlayerID,"cpm \"You have been moved to spec by the admin.\"\n")
end

function PutTeam(PlayerID,team)
	if(string.lower(team)=="r" or string.lower(team)=="red" or string.lower(team)=="axis") then
		et.trap_SendConsoleCommand( et.EXEC_APPEND, "ref putaxis " .. PlayerID .. "\n" )
		et.trap_SendServerCommand( PlayerID,"cpm \"You have been moved to axis by the admin.\"\n")
	elseif (string.lower(team)=="b" or string.lower(team)=="blue" or string.lower(team)=="allies") then
		et.trap_SendConsoleCommand( et.EXEC_APPEND, "ref putallies " .. PlayerID .. "\n" )
		et.trap_SendServerCommand( PlayerID,"cpm \"You have been moved to alies by the admin.\"\n")
	end
end
