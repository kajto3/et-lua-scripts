-- misc ET constants
-- [23:10] <|Rain|> 2 became CS_ETPRO_INFO instead of CS_MUSIC, because I needed the version info before any more configstrings were parsed
-- [23:10] <|Rain|> and CS_MUSIC moved up to 53

-- misc q_shared.h 
et.MAX_CLIENTS = 64 -- JPW NERVE back to q3ta default was 128  // absolute limit

et.MAX_MODELS = 256  -- these are sent over the net as 8 bits (Gordon: upped to 9 bits, erm actually it was already at 9 bits, wtf? NEVAR TRUST GAMECODE COMMENTS, comments are evil :E, lets hope it doesnt horribly break anything....)
et.MAX_SOUNDS = 256  -- so they cannot be blindly increased
et.MAX_CS_SKINS = 64
et.MAX_CSSTRINGS = 32
...
et.MAX_TAG_FILES = 64
et.MAX_MULTI_SPAWNTARGETS = 16 -- JPW NERVE
...
et.CS_MOTD =       4  -- g_motd string for server message of the day
...
et.CS_TARGETEFFECT =     20  ------(SA) 
et.CS_WOLFINFO =      21  -- NERVE - SMF
...
et.CS_MAIN_AXIS_OBJECTIVE =   25  -- Most important current objective
...
et.CS_SHADERSTATE =     ( et.CS_SHADERS + et.MAX_CS_SHADERS    ) -- Gordon: this MUST be after CS_SHADERS
