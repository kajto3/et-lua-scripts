...
function AdjustCvarsValues( numclients )
	...
	if (numclients < 8) and unlockvalue > 13 then
		for j = 0, maxClients do
			...
			et.gentity_set(j, "ps.ammo", 39, 0)			--WP_GPG40
			et.gentity_set(j, "ps.ammoclip", 39, 0)		--WP_GPG40
			et.gentity_set(j, "ps.ammo", 40, 0)			--WP_M7
			et.gentity_set(j, "ps.ammoclip", 40, 0)		--WP_M7
