...
c.spawns[2] = {pos = {2645, 3975, 1524}, radius = 250}
c.spawns[3] = {state = NO_PROTECT}
c.spawns[4] = {radius = 650}
c.spawns[6] = {radius = 200}
c.spawns[7] = {name = "Villa*", pos = {2522, 3064, 1524}, state = PROTECT_ALLIES, radius = 200}
