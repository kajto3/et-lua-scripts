...
warmup_exec_cfg = "scanhard.cfg"
playing_antiloop = true
playing_exec_cfg = "scanlow.cfg"
...
cmd = string.lower(cmd)
	...
	local ref_typo = "7ref" --ref typo protection
	local argv1 = string.lower(et.trap_Argv(1))
	if string.find(argv1, "^" .. ref_typo .. "") then
		et.trap_SendServerCommand( cno, "cpm \"^:Ckeck your typing\"" )
		return 1
	end

if cmd == "team" then --exploitfix /team follow2
	if et.trap_Argv(1) == "follow2" then
		return 1 --prevent it
	end
end
